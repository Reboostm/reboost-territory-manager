...
.rb-fp-mw{margin-top:-33px;background:linear-gradient(180deg,#1e1e2e 0%,#252533 100%);border-radius:0;padding:40px 32px;border:none;border-top:1px solid rgba(217,119,6,.15);box-shadow:none}
